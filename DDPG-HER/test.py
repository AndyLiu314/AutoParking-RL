...
# Load the trained model with new test environment
...
plt.title('Parking Trajectories')
...
plt.tight_layout()
plt.savefig('ddpg_her_test_results.png', dpi=300, bbox_inches='tight')
plt.show()

# Print summary stats
print(f"\nDDPG-HER Test Results (50 episodes):")
